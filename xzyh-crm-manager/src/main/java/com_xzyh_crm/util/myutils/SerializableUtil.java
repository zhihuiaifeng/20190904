...
public class SerializableUtil {
    ...
    public static byte[] serializable(Object object) {
        ...
        try {
            ...
            throw new CustomException("SerializableUtil工具类序列化出现IOException异常:" + e.getMessage(),"106");
        } finally {
            try {
                if (oos != null) {
                    oos.close();
                ...
                throw new CustomException("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage(),"106");
            }
        }
    }
    ...
    public static Object unserializable(byte[] bytes) {
        ...
        try {
            ...
            throw new CustomException("SerializableUtil工具类反序列化出现ClassNotFoundException异常:" + e.getMessage(),"106");
        } catch (IOException e) {
            LOGGER.error("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage());
            throw new CustomException("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage(),"106");
        } finally {
